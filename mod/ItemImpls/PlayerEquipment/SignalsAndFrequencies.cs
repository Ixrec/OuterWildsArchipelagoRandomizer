...
internal class SignalsAndFrequencies
{
    ...
    // Warn the player about the unfortunate compatibility issue between The Outsider and Astral Codec
    ...
    public static void ShipLogManager_RevealFact_Prefix(string id, bool saveGame, bool showNotification)
    {
        ...
        if (id == "codex_bramble_station")
        {
            ...
            if (
                ...
                "Translation Probe Thicket and the nearby scroll may be invisible. You can still scan the signal and pick up the scroll.");
        }
    }
